...
Reports parse errors (ERROR/MISSING nodes) with line numbers. Returns exit code 1 when there are no errors (clean file). Works on any language with a grammar installed.
