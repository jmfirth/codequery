...
pub fn run(
    ...
    // 6b. Merge: add syntactic references that the cascade missed.
    // Cascade results are higher confidence — keep them. Add syntactic
    // results at locations the cascade didn't cover.
    {
