...
pub fn parse_symbol_kind(s: &str) -> Option<SymbolKind> {
    match s.to_lowercase().as_str() {
        ...
        "type" | "type_alias" | "module_type" => Some(SymbolKind::Type),
        "const" | "constant" => Some(SymbolKind::Const),
        "static" => Some(SymbolKind::Static),
        "module" => Some(SymbolKind::Module),
        "impl" => Some(SymbolKind::Impl),
        "test" => Some(SymbolKind::Test),
        "macro" | "directive" => Some(SymbolKind::Macro),
        "variable" | "var" | "binding" => Some(SymbolKind::Variable),
        // Language-specific constructs
        "namespace" => Some(SymbolKind::Namespace),
        "package" => Some(SymbolKind::Package),
        "record" => Some(SymbolKind::Record),
        "signature" | "type_signature" => Some(SymbolKind::Signature),
        "mixin" => Some(SymbolKind::Mixin),
        "extension" | "category" => Some(SymbolKind::Extension),
        "export" => Some(SymbolKind::Export),
        "port" => Some(SymbolKind::Port),
        "exception" => Some(SymbolKind::Exception),
        "event" => Some(SymbolKind::Event),
        // Infrastructure / config constructs
        "resource" => Some(SymbolKind::Resource),
        "data" | "data_source" => Some(SymbolKind::Data),
        "output" => Some(SymbolKind::Output),
        "config" | "configuration" => Some(SymbolKind::Config),
        "rule" => Some(SymbolKind::Rule),
        "stage" => Some(SymbolKind::Stage),
        "label" => Some(SymbolKind::Label),
        "route" | "location" => Some(SymbolKind::Route),
        "block" => Some(SymbolKind::Block),
        "service" => Some(SymbolKind::Service),
        "message" => Some(SymbolKind::Message),
        // Document / markup constructs
        "section" | "heading" => Some(SymbolKind::Section),
        "element" => Some(SymbolKind::Element),
        "environment" => Some(SymbolKind::Environment),
        "property" => Some(SymbolKind::Property),
        "table" => Some(SymbolKind::Table),
        "view" => Some(SymbolKind::View),
        "procedure" | "stored_procedure" => Some(SymbolKind::Procedure),
        "index" => Some(SymbolKind::Index),
        "field" => Some(SymbolKind::Field),
        "file" => Some(SymbolKind::File),
        "hunk" => Some(SymbolKind::Hunk),
